import { PenSquare, ShieldCheck, Database, ArrowRight } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <h1 className="mt-6 text-5xl lg:text-6xl font-extrabold leading-tight">
            Create, Manage &<span className="text-blue-400"> Share Posts</span>{' '}
            Effortlessly.
          </h1>
          ...
          <div className="mt-10 flex gap-4">
            ...
            <button
              onClick={() => navigate('/posts')}
              className="border border-slate-600 hover:border-blue-500 hover:text-blue-400 px-6 py-3 rounded-xl transition"
            >
              Explore Posts
            </button>
          </div>
          ...
          <div className="relative bg-slate-900/70 backdrop-blur-lg border border-slate-700 rounded-3xl p-8 shadow-2xl">
            <div className="space-y-6">
              ...
              <div
                ...
                className="flex items-center gap-4 p-5 rounded-2xl bg-slate-800 hover:bg-slate-700 transition cursor-pointer"
              >
              ...
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-slate-800">
